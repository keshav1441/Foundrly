...
- **Matching System** - Match with users who liked the same idea
...
│   ├── src/
│   │   ├── modules/  # Feature modules (auth, users, ideas, matches, chat, ai, memes)
...
### Matches
- `POST /api/match/swipe` - Swipe on an idea
...
3. **Match**: When two users like the same idea, they match!
4. **Chat**: Real-time chat with your matches
5. **Feed**: Browse and submit memes
6. **Profile**: Customize your founder profile
